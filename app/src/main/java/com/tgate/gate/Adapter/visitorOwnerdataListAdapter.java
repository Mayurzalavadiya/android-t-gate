...
public class visitorOwnerdataListAdapter extends LoadMoreRecyclerAdapter<visitorOwnerdataListAdapter.myVisitordataListHolder, VisitordataResponse.Datum> {
    Context context;


    public visitorOwnerdataListAdapter(List<VisitordataResponse.Datum> data, Context context) {
        super(data);
    ...
    public void onBindHolder(myVisitordataListHolder holder, int position) {
        ...
        VisitordataResponse.Datum getVisitordataList=getItem(position);
...
/*        holder.txt_accept.setOnClickListener(new View.OnClickListener() {
    ...
    public class myVisitordataListHolder extends BaseRecyclerAdapter<visitorOwnerdataListAdapter.myVisitordataListHolder, VisitordataResponse.Datum>.ViewHolder  {
