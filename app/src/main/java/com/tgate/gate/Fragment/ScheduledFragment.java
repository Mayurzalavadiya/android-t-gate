...
public class ScheduledFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        endlessRecyclerOnScrollListener = new EndlessRecyclerOnScrollListener(layoutManager) {
            ...
            public void onLoadMore(int current_page) {
                ...
                isIndex1 = false;
                scheduledlist(current_page);
                Log.d("SPage", String.valueOf(current_page));
    ...
    private void scheduledlist(int page) {

        if (Utility.isInternetAvailable(getActivity())) {
//            Utility.showCustomProgressDialog(getActivity());
            RestClient.getInstance().getApiInterface().visitordata_Guard_response("SCHEDULED", page, PrefsManager.readStringPrefsVal(PrefsManager.STAFF_ID), PrefsManager.readStringPrefsVal(PrefsManager.IS_LOGIN)).enqueue(new Callback<VisitorDataGuardresponse>() {
                @Override
