...
public class ScheduledOwnerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_scheduled_owner, container, false);
...
//            Utility.showCustomProgressDialog(getActivity());
            RestClient.getInstance().getApiInterface().visitor_data_response("2","SCHEDULED", page,  PrefsManager.readStringPrefsVal(PrefsManager.IS_LOGIN)).enqueue(new Callback<VisitordataResponse>() {
                @Override
