...
public class PastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        endlessRecyclerOnScrollListener = new EndlessRecyclerOnScrollListener(layoutManager) {
            ...
            public void onLoadMore(int current_page) {
                ...
                isIndex1 = false;
                past(current_page);
                Log.d("PPage", String.valueOf(current_page));
    ...
    private void past(int page) {

        if (Utility.isInternetAvailable(getActivity())) {
           // Utility.showCustomProgressDialog(getActivity());
            RestClient.getInstance().getApiInterface().visitordata_Guard_response("PAST", page, PrefsManager.readStringPrefsVal(PrefsManager.STAFF_ID), PrefsManager.readStringPrefsVal(PrefsManager.IS_LOGIN)).enqueue(new Callback<VisitorDataGuardresponse>() {
                @Override
